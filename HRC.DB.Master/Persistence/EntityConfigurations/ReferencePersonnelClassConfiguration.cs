...
namespace HRC.DB.Master.Persistence.EntityConfigurations
{
    ...
    /// <see cref="ReferencePersonnelClass"/> for use with code-first migrations
    /// </summary>
    /// <remarks>
    /// Data annotations should not be added to <see cref="ReferencePersonnelClass"/> so the code
    /// controlling database schema remains maintained only in this class.
    /// </remarks>
    public class ReferencePersonnelClassConfiguration : IEntityTypeConfiguration<ReferencePersonnelClass>
    {
        public const int CodeLength = 2;
        public const int LongNameLength = 60;

        public void Configure(EntityTypeBuilder<ReferencePersonnelClass> builder)
        {
            builder.ToTable("RE_PERSONNEL_CLASS", "PERSON");
