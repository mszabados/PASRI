...
{
    /// <summary>
    /// Extends the <see cref="Repository{TEntity}"/> for <see cref="ReferenceGender"/>, implementing
    /// <see cref="IReferenceGenderRepository"/>, using the <see cref="MasterDbContext"/> to get,
    /// find with predicate, add, or remove <see cref="ReferenceGender"/> objects in the database in
    ...
    /// </remarks>
    public class ReferenceGenderRepository : Repository<ReferenceGender>, IReferenceGenderRepository
    {
        public ReferenceGenderRepository(DbContext context)
            : base(context)
        {
        }
    }
