...
{
    /// <summary>
    /// Extends the <see cref="Repository{TEntity}"/> for <see cref="ReferenceAccessionSource"/>, implementing
    /// <see cref="IReferenceAccessionSourceRepository"/>, using the <see cref="MasterDbContext"/> to get,
    /// find with predicate, add, or remove <see cref="ReferenceAccessionSource"/> objects in the database in
    ...
    /// </remarks>
    public class ReferenceAccessionSourceRepository : Repository<ReferenceAccessionSource>, IReferenceAccessionSourceRepository
    {
        public ReferenceAccessionSourceRepository(DbContext context)
            : base(context)
        {
        }
    }
