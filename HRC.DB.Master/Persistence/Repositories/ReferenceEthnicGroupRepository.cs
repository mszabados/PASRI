...
{
    /// <summary>
    /// Extends the <see cref="Repository{TEntity}"/> for <see cref="ReferenceEthnicGroup"/>, implementing
    /// <see cref="IReferenceEthnicGroupRepository"/>, using the <see cref="MasterDbContext"/> to get,
    /// find with predicate, add, or remove <see cref="ReferenceEthnicGroup"/> objects in the database in
    ...
    /// </remarks>
    public class ReferenceEthnicGroupRepository : Repository<ReferenceEthnicGroup>, IReferenceEthnicGroupRepository
    {
        public ReferenceEthnicGroupRepository(DbContext context)
            : base(context)
        {
        }
    }
