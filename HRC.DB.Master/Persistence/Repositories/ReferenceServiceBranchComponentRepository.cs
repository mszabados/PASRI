...
{
    /// <summary>
    /// Extends the <see cref="Repository{TEntity}"/> for <see cref="ReferenceServiceBranchComponent"/>, implementing
    /// <see cref="IReferenceServiceBranchComponentRepository"/>, using the <see cref="MasterDbContext"/> to get,
    /// find with predicate, add, or remove <see cref="ReferenceServiceBranchComponent"/> objects in the database in
    ...
    /// </remarks>
    public class ReferenceServiceBranchComponentRepository : Repository<ReferenceServiceBranchComponent>, IReferenceServiceBranchComponentRepository
    {
        public ReferenceServiceBranchComponentRepository(DbContext context)
            : base(context)
        {
        }
    }
