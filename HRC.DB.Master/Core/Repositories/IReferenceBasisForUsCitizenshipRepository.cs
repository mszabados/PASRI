...
{
    /// <summary>
    /// Extends the <see cref="IRepository{TEntity}"/> for <see cref="ReferenceBasisForUsCitizenship"/>
    ...
    /// </remarks>
    public interface IReferenceBasisForUsCitizenshipRepository : IRepository<ReferenceBasisForUsCitizenship>
    {
    }
}
