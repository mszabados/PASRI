...
{
    /// <summary>
    /// Extends the <see cref="IRepository{TEntity}"/> for <see cref="ReferenceServiceBranchComponent"/>
    ...
    /// </remarks>
    public interface IReferenceServiceBranchComponentRepository : IRepository<ReferenceServiceBranchComponent>
    {
    }
}
