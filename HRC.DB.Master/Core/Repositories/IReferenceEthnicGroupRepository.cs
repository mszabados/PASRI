...
{
    /// <summary>
    /// Extends the <see cref="IRepository{TEntity}"/> for <see cref="ReferenceEthnicGroup"/>
    ...
    /// </remarks>
    public interface IReferenceEthnicGroupRepository : IRepository<ReferenceEthnicGroup>
    {
    }
}
