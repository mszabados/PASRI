...
{
    /// <summary>
    /// Extends the <see cref="IRepository{TEntity}"/> for <see cref="ReferenceAccessionSource"/>
    ...
    /// </remarks>
    public interface IReferenceAccessionSourceRepository : IRepository<ReferenceAccessionSource>
    {
    }
}
