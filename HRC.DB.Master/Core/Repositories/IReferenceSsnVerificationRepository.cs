...
{
    /// <summary>
    /// Extends the <see cref="IRepository{TEntity}"/> for <see cref="ReferenceSsnVerification"/>
    ...
    /// </remarks>
    public interface IReferenceSsnVerificationRepository : IRepository<ReferenceSsnVerification>
    {
    }
}
