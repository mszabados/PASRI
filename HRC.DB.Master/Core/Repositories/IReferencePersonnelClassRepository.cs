...
{
    /// <summary>
    /// Extends the <see cref="IRepository{TEntity}"/> for <see cref="ReferencePersonnelClass"/>
    ...
    /// </remarks>
    public interface IReferencePersonnelClassRepository : IRepository<ReferencePersonnelClass>
    {
    }
}
