...
{
    /// <summary>
    /// Extends the <see cref="IRepository{TEntity}"/> for <see cref="ReferenceServiceBranch"/>
    ...
    /// </remarks>
    public interface IReferenceServiceBranchRepository : IRepository<ReferenceServiceBranch>
    {
    }
}
