...
{
    /// <summary>
    /// Extends the <see cref="IRepository{TEntity}"/> for <see cref="ReferenceNameSuffix"/>
    ...
    /// </remarks>
    public interface IReferenceNameSuffixRepository : IRepository<ReferenceNameSuffix>
    {
    }
}
