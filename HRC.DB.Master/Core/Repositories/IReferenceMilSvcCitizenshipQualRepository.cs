...
{
    /// <summary>
    /// Extends the <see cref="IRepository{TEntity}"/> for <see cref="ReferenceMilSvcCitizenshipQual"/>
    ...
    /// </remarks>
    public interface IReferenceMilSvcCitizenshipQualRepository : IRepository<ReferenceMilSvcCitizenshipQual>
    {
    }
}
