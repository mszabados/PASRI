...
{
    /// <summary>
    /// Extends the <see cref="Repository{TEntity}"/> for <see cref="ReferenceNameSuffix"/>, implementing
    /// <see cref="IReferenceNameSuffixRepository"/>, using the <see cref="PasriDbContext"/> to get,
    /// find with predicate, add, or remove <see cref="ReferenceNameSuffix"/> objects in the database in
    ...
    /// </remarks>
    public class ReferenceNameSuffixRepository : Repository<ReferenceNameSuffix>, IReferenceNameSuffixRepository
    {
        public ReferenceNameSuffixRepository(PasriDbContext context)
            : base(context)
        {
        }
    }
