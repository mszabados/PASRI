...
namespace PASRI.Persistence.Repositories
{
    ...
    /// <see cref="IReferenceSuffixNameRepository"/>, using the <see cref="PasriDbContext"/> to get,
    /// find with predicate, add, or remove <see cref="ReferenceSuffixName"/> objects in the database in
