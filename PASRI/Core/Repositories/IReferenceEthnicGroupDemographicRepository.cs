...
{
    /// <summary>
    /// Extends the <see cref="IRepository{TEntity}"/> for <see cref="ReferenceEthnicGroupDemographic"/>
    ...
    /// </remarks>
    public interface IReferenceEthnicGroupDemographicRepository : IRepository<ReferenceEthnicGroupDemographic>
    {
    }
}
