...
{
    /// <summary>
    /// Extends the <see cref="IRepository{TEntity}"/> for <see cref="ReferenceReligionDemographic"/>
    ...
    /// </remarks>
    public interface IReferenceReligionDemographicRepository : IRepository<ReferenceReligionDemographic>
    {
    }
}
