...
{
    /// <summary>
    /// Extends the <see cref="IRepository{TEntity}"/> for <see cref="ReferenceSuffixName"/>
    ...
    /// </remarks>
    public interface IReferenceSuffixNameRepository : IRepository<ReferenceSuffixName>
    {
    }
}
