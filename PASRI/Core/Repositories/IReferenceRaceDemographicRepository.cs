...
{
    /// <summary>
    /// Extends the <see cref="IRepository{TEntity}"/> for <see cref="ReferenceRaceDemographic"/>
    ...
    /// </remarks>
    public interface IReferenceRaceDemographicRepository : IRepository<ReferenceRaceDemographic>
    {
    }
}
