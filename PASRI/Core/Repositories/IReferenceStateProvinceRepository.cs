...
{
    /// <summary>
    /// Extends the <see cref="IRepository{TEntity}"/> for <see cref="ReferenceStateProvince"/>
    ...
    /// </remarks>
    public interface IReferenceStateProvinceRepository : IRepository<ReferenceStateProvince>
    {
    }
}
